...
interface EstudianteCrearFormularioParametros {
    onCancelar?: () => void;
    estudianteModificar?: Estudiante | null;
}
 ...
 * @returns 
 */
export default function EstudiantesCrearDialogo(params: EstudianteCrearFormularioParametros) {
    ...
    const onGuardar = () => {
        ...
        if (formData.id) { //Modificar estudiante
            ControladorEstudiante.modificarEstudiante(formData).then((resultado) => {
                ...
                console.error('Ha ocurrido un error al modificar los datos del estudiant', error);
    ...
    return (
        <React.Fragment>
            ...
            >
                <DialogTitle>Adicionar estudiante</DialogTitle>
